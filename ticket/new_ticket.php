...
<input type="text" name="email" placeholder="Enter a valid email address" required value=""  />
</fieldset>
...
<fieldset>
    <label>Subject</label>
    <input type="text" name="subject" placeholder="Subject of your request" required="required" value=""  />
</fieldset>

<fieldset>
    <label>Your Query</label>
    <textarea class="span5" rows="15" name="body"></textarea>
</fieldset>
